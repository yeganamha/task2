...
namespace task2
{
    internal class Unibank : Card 
    {
        public Unibank(string fullname, string code, int cvv, decimal balance):base(fullname, code, cvv, balance)
        {
        ...
        {
            return
                Balance = Balance - (money+money * 1.5m/100);
        }
